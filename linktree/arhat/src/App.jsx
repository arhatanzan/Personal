...
function App() {
  console.log('App rendering, siteData:', siteData);
  ...
  const renderSection = (key, index) => {
      ...
      switch(key) {
          ...
          case 'publications':
              ...
              break;
          case 'connectLinks':
              content = <LinkSection items={activeData.connectLinks} isConnect={true} theme={theme} id="connect-container" />;
              break;
          case 'footer':
              content = <Footer text={activeData.footer} />;
              break;
          case 'backButton':
              content = (
