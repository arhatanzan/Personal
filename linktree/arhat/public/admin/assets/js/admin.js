...
function renderThemeSettings() {
    ...
    // Check if current font is a known preset
    const currentFont = currentData.theme.fontFamily || "'Montserrat', sans-serif";
    const knownFonts = [
        "'Montserrat', sans-serif", "'Open Sans', sans-serif", "'Lato', sans-serif", 
        "'Poppins', sans-serif", "'Roboto', sans-serif", "'Merriweather', serif", 
        "'Playfair Display', serif", "'Lora', serif", "'Georgia', serif", 
        "'Courier New', monospace"
    ];
    // Simple check: if it's not one of the exact known strings, treat as custom
    // Note: This is a bit loose but works for the UI toggle
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="color" class="form-control form-control-color w-100" 
                            value="${currentData.theme.backgroundColor || '#ffffff'}" 
                            onchange="updateThemeSetting('backgroundColor', this.value)">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Text Color</label>
                        <input type="color" class="form-control form-control-color w-100" 
                            value="${currentData.theme.textColor || '#023e62'}" 
                            onchange="updateThemeSetting('textColor', this.value)">
                    </div>
                    <div class="col-md-4">
                            ...
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" 
                                        ...
                                        value="${isCustom ? currentFont : ''}"
                                        onchange="updateThemeSetting('fontFamily', this.value)">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm" 
                                        ...
                                        value="${currentData.theme.customFontUrl || ''}"
                                        onchange="updateThemeSetting('customFontUrl', this.value)">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" 
                            value="${currentData.theme.backgroundImage || ''}" 
                            placeholder="https://example.com/image.jpg"
                            onchange="updateThemeSetting('backgroundImage', this.value)">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" 
                            value="${currentData.theme.fontSize || 16}" 
                            onchange="updateThemeSetting('fontSize', this.value)">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Section Spacing (px)</label>
                        <input type="number" class="form-control" 
                            value="${currentData.theme.sectionSpacing || 30}" 
                            onchange="updateThemeSetting('sectionSpacing', this.value)">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Text Spacing (px)</label>
                        <input type="number" class="form-control" 
                            value="${currentData.theme.textSpacing || 15}" 
                            onchange="updateThemeSetting('textSpacing', this.value)">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Button Spacing (px)</label>
                        <input type="number" class="form-control" 
                            value="${currentData.theme.btnSpacing || 15}" 
                            onchange="updateThemeSetting('btnSpacing', this.value)">
                    </div>
                </div>
...
window.updateThemeSetting = function(key, value) {
    if (!currentData.theme) currentData.theme = {};
    currentData.theme[key] = value;
};

window.handleFontSelection = function(value) {
    const customInputs = document.getElementById('customFontInputs');
    if (value === 'custom') {
        customInputs.classList.remove('d-none');
        // Don't update fontFamily yet, let the user type it
    } else {
        customInputs.classList.add('d-none');
        updateThemeSetting('fontFamily', value);
        // Clear custom url so it doesn't load unnecessary css
